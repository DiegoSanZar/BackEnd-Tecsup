...
class TaskModelListView(ListView):
    ...
    #2. La vista debe estar dentro de una carpeta llamada igual a la applicacion /app/MODELNAME_list.html
    #3. El listado de todos los registros del modelo (SELECT * FROM)
